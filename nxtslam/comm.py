...
class NxtSlamComm(object):

  """An interface to the the nxt robot"""
...
class NxtSlamCommListenerThread(threading.Thread):
  """A thread to handle nxt communication in the background"""

  def __init__(self, on_new_data = None, on_status = None):
    super(NxtSlamCommListenerThread,self).__init__()
